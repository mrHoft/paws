## Nimble Paws
A nimble cat on an endless adventure! Time your jumps to catch prey and avoid obstacles. Hold to charge your leap—the longer you hold, the bigger the jump! Unlock new locations, catch animals and build combos in this charming and challenging arcade game.

### Description
Step into the paws of a nimble cat in this cute arcade-platformer! Your goal is simple: catch prey and avoid obstacles by mastering the charge-jump mechanic. Press and hold to aim your leap—precision is key! Succeed, and you'll earn points and build a combo multiplier. Fail, and you'll be sent back with a score penalty.
...
### How to Play
- Control: Press and hold the SPACEBAR, MOUSE/GAMEPAD button, or TAP to make the cat jump. The longer you hold, the higher and further the leap.
...
- Upgrades allow you to catch prey better, run and jump faster.
